...
CREATE TABLE IF NOT EXISTS partners (
    ...
    work_images TEXT COMMENT 'JSON array or comma-separated paths',
    pricing TEXT,
...
-- Table: partner_earnings (Added for financial tracking)
...
-- Table: partner_img (Added for additional gallery images)
...
-- Clear existing data to avoid conflicts with manual IDs
...
-- 1. service_categories (10 entries)
...
-- 6. partner_availability (10 entries)
...
-- 13. partner_documents (10 entries)
...
-- 14. withdrawal_requests (10 entries)
